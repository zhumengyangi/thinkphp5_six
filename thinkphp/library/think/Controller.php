...
class Controller
{
    ...
    {
        header("Access-Control-Allow-Origin: http://www.six.com");
        // $allow_origin = array(
        //     //'http://www.six.com',
        //     'http://test.six_admin_manage.com',
        // );
    ...
    /**
     * 生成sign签名的函数+进行签名的校验
     * @param array $params  接口请求传递的参数
     * @return array
     */
    public function createSign($params)
    {
        
        $sercet = '1q2w3e!@#'; //sign签名加密约定的秘钥
    ...
    //公共校验token值得内容
    public function checkCommonToken($params)
    {
